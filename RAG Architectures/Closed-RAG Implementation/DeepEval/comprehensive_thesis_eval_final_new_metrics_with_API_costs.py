...
async def main():
    """Main function"""
    # Configuration
    DATASET_PATH = "/home/user/Desktop/RAG_pipeline_claude_eval_v2/merged_output_file_classes.json"
    ...
    evaluator = FixedComprehensiveEvaluator(
        ...
        azure_deployment=AZURE_DEPLOYMENT,
        azure_endpoint=AZURE_ENDPOINT,
        output_dir="fixed_comprehensive_results_other_qns_final_eval_results"
    )
    ...
    # Configuration
    num_questions = 39  # Test with 39 questions
    selected_metrics = [
        'contextual_relevancy',
        'contextual_recall',
        'contextual_precision',
